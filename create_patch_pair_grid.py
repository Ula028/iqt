...
path = 'images/patches/' + str(index) + 'patch_lr.png'
...
path = 'images/patches/' + str(index) + 'patch_hr.png'
window.record(scene, n_frames=1, out_path=path,
                size=(1200, 1200))
...
path = 'images/patches/' + str(index) + 'patch_rec_lin_reg.png'
window.record(scene, n_frames=1, out_path=path,
                size=(1200, 1200))
...
path = 'images/patches/' + str(index) + 'patch_rec_reg_tree.png'
window.record(scene, n_frames=1, out_path=path,
                size=(1200, 1200))
...
path = 'images/patches/' + str(index) + 'patch_rec_ran_forest.png'
window.record(scene, n_frames=1, out_path=path,
                size=(1200, 1200))